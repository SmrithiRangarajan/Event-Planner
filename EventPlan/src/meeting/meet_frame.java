...
public class meet_frame extends JFrame {
    ...
    public meet_frame(){
        setTitle("CORPORATE ANNIVERSARIES");
        setSize(1000,680);
        setLayout(null);
        ...
        ImageIcon icon1 = new ImageIcon("C:\\Users\\smrit\\OneDrive\\Desktop\\java project\\cake.jpg");//icon used for the tabs
       ...
       public void actionPerformed(ActionEvent ae) {
           int res = JOptionPane.showConfirmDialog(cek, "Confirm and calculate?", "Total", JOptionPane.YES_NO_OPTION,
               JOptionPane.QUESTION_MESSAGE);
           if(res == JOptionPane.YES_OPTION) {
               evetotal = cakeprice + foodprice + venueprice;
        ...
        //TITLE (HEADING)
        JLabel bday = new JLabel("BUSINESS ANNIVERSARY!");
        bday.setForeground(Color.white);
        bday.setFont(new Font("futura", Font.BOLD, 20));
        bday.setBounds(370,10,300,20);
